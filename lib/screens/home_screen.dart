    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(children: [
          const Spacer(flex: 2),
          Icon(Icons.route_rounded, color: kAccent, size: 82),
          const SizedBox(height: 18),
          Text('FLOWFORGE',
              style: techno(40, color: kAccent, weight: FontWeight.w900, letterSpacing: 6)),
          const SizedBox(height: 8),
          Text('ONE LINE · EVERY CELL', style: techno(11, color: kTextDim, letterSpacing: 4)),
  ...
  Widget _btn(BuildContext context, String label, IconData icon, bool primary,
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: primary
                ? const LinearGradient(colors: [Color(0xFFC9701F), Color(0xFFFF9D3D)])
                : null,
